...
import com.example.register.model.validations.ValidationResult
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtStudentId = findViewById(R.id.tvStudentID)
        tvYear = findViewById(R.id.tvAcademicYear)
        spnYear = findViewById(R.id.spinYear)
        tvSemester = findViewById(R.id.tvSemester)
        spnSemester = findViewById(R.id.spinnerSemester)
        cbAgree = findViewById(R.id.checkboxTerms)
